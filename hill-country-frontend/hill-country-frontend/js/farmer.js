...
function renderSlider(id, images) {
  ...
  return `
    <div class="slider">
      ...
      <img id="img-${id}" src="https://kandyan-harvest.vercel.app/uploads/${first}">
...
function prevImg(id) {
  ...
  if (img) img.src = `https://kandyan-harvest.vercel.app/uploads/${images[idx]}`;
}
...
async function acceptOrder(id) {
  await fetch(`${API}/farmer/orders/${id}/accept`, {
    method: "PUT",
    headers: {
      Authorization: `Bearer ${token}`
    }
