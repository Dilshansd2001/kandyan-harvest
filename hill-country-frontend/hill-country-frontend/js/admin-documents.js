...
function renderDocuments(user) {
  ...
  if(user.farmPhoto) {
    html += `
      <p>Farm Photo:</p>
      <img src="https://kandyan-harvest.vercel.app/uploads/${user.farmPhoto}" width="200">
    `;
  }
  ...
  if(user.brnDoc) {
    html += `
      <p>BRN Document:</p>
      <a href="https://kandyan-harvest.vercel.app/uploads/${user.brnDoc}" target="_blank">
        View Document
      </a>
    `;
  }
  ...
  if(user.licenseDoc) {
    html += `
      ...
      <img src="https://kandyan-harvest.vercel.app/uploads/${user.licenseDoc}" width="200">
    `;
  }
